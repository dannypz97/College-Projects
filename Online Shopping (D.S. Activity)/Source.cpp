...
{ "Asus Zenfone 3",19000.00,1,0,100 },{ "Apple Iphone 7",68599.00,1,0,10 },{ "OnePlus 3",2799.00,1,0,3} ,{ "Nexus 6P",39998.00,1,0,6} ,{ "Toshiba Satellite C-180X",35000.00,2,0,10 },
{ "Asus Rog 552JX",85000.00,2,0,10 },{ "Jas U8 Smartwatch",790.00,3,0,5 },{ "Apple Watch Sport 38mm",16900.00,3,0,5 },{ "Samsung Gear S2",23085.00,3,0,2 },
...
void main()
{
	...
	while (1)
	{
		...
		switch (ch)
		{
		case '1': usr_logged = "GUEST";
			landing();
			break;
		case '2':login();
			break;
		case '3':create_user(); break;
		case '4': exit(0);
		}
	}
...
void cart_options()
{
	...
	while (1)
	{
		...
		case '5':main(); break;
		case '2':search(); break;
		case '1':landing(); break;
		case 's':if(start_c)temp_c = temp_c->next; break;
		case 'w':if(start_c)temp_c = temp_c->prev; break;
		case 'a': if (start_c)
		{
			temp_p = start_p;
...
void choose_disp()
{
	...
	switch (ch)
	{
	case '1':disp_mode = 1; break;
	case '2':disp_mode = 2; break;
	case '3':disp_mode = 3; break;
	case '4':disp_mode = 0; break;
